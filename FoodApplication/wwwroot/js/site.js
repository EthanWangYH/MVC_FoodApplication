...
let apikey = "3feac09b-403b-4b43-ad21-cb684d8d1d9e";
...
function removeCartfromList(recipeId) {
    console.log("Removing cart with RecipeId: " + recipeId);
    let data = { Id: recipeId };
